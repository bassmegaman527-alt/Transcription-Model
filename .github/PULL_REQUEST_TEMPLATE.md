...
This PR should address only one checklist item from Issue #7.

- [ ] I only worked on one checklist item
- [ ] I did not add unrelated features
- [ ] I tested the app in Android Studio
- [ ] I tested on a physical Android phone, if applicable
- [ ] The checklist item can be marked complete
...
Ran Gradle sync.
Built app.
Installed on physical Android phone.
Confirmed app opened successfully.
