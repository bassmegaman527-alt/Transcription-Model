...
This repository currently contains a minimal Android Studio project scaffold. Voice capture, transcription, local note storage, automated tests, and full runnable app instructions should be added in future implementation changes.
